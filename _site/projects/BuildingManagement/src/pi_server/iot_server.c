...
int main(int argc, char *argv[])
{
		...
		CLIENT_INFO client_info[MAX_CLNT] = {{0,-1,"","BMS_ARD","PASSWD"}, \
				{0,-1,"","BMS_LIN","PASSWD"},  {0,-1,"","BMS_AND","PASSWD"}, \
				{0,-1,"","BMS_STM32","PASSWD"},  {0,-1,"","BMS_BT","PASSWD"}, \
				{0,-1,"","BMS_SQL","PASSWD"},  {0,-1,"","7","PASSWD"}, \
				{0,-1,"","BMS_1F","PASSWD"},  {0,-1,"","BMS_2F","PASSWD"}, \
				{0,-1,"","BMS_3F","PASSWD"},  {0,-1,"","BMS_4F","PASSWD"}, \
				{0,-1,"","BMS_5F","PASSWD"},  {0,-1,"","13","PASSWD"}, \
